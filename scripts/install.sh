...
CDN="https://cdn-hub.fazerai.com/coolify"
...
echo ""
echo "=========================================="
echo "   Coolify (fazer.ai fork) Installation - ${DATE}"
echo "=========================================="
echo ""
echo "Welcome to the fazer.ai Coolify Installer!"
echo "This script will install everything for you. Sit back and relax."
echo "Source code: https://github.com/fazer-ai/coolify/blob/v4.x/scripts/install.sh"
